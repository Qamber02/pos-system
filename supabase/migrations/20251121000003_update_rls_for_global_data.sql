...
-- 1. Products
DROP POLICY IF EXISTS "Users can view own or global products" ON public.products;
...
-- 2. Categories
DROP POLICY IF EXISTS "Users can view own or global categories" ON public.categories;
...
-- 3. Product Variants
DROP POLICY IF EXISTS "Users can view own or global product variants" ON public.product_variants;
...
DROP POLICY IF EXISTS "Users can view own or global customers" ON public.customers;
